...
public class LinkRepresentation extends Representation<LinkRepresentation.Link> {
    ...
    public void draw() {
        ...
        // Halo.
        double haloWeight = highlight ? OverviewConstants.LINK_WIDTH + 4f : OverviewConstants.LINK_WIDTH + 2f;
        StaticGraphics.color(org.cwi.examine.graphics.draw.Parameters.backgroundColor);
        StaticGraphics.strokeWeight(haloWeight);
        drawLink();
        
        // Actual edge.
        double edgeWeight = highlight ? OverviewConstants.LINK_WIDTH + 2f : OverviewConstants.LINK_WIDTH;
    ...
    public void beginHovered() {
        ...
        Set<NetworkNode> hP = new HashSet<NetworkNode>();
        ...
        Set<NetworkAnnotation> hT = new HashSet<NetworkAnnotation>();
    ...
    public static class Link {
        ...
        public Link(NetworkNode node1, NetworkNode node2) {
            this.node1 = node1;
            this.node2 = node2;
        }
